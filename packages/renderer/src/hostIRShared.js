...
import { isDirectBindingSource, resolveEventHandler, resolveExpr, resolveHintedDirectSource, resolveHintedPath, } from "./renderFromIRExpressions.js";
export function applyIRProps(el, props, ctx, runtime) {
...
export function normalizeSlotValue(value, runtime) {
