...
export type HostIRNode = HostIRTextNode | HostIRInterpolationNode | HostIRElementNode | HostIRPortalNode | HostIRSlotNode | HostIRIfNode | HostIRForNode;
export interface HostIRModule {
    filePath: string;
    template: HostIRNode[];
}
//# sourceMappingURL=hostIRTypes.d.ts.map