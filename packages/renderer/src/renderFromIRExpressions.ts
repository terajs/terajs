...
export function resolveHintedDirectSource(ctx: any, binding: HostIRBindingHint): any {
...
export function resolveHintedPath(ctx: any, binding: HostIRBindingHint, invokeFinal: boolean): any {
