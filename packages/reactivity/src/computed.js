...
import { currentEffect, withDetachedCurrentEffect } from "./deps.js";
...
import { addDependency, createReactiveMetadata, getCurrentComposable, registerReactiveInstance, updateReactiveValue, Debug, getCurrentContext, } from "@terajs/shared";
/**
