 ...
 */
export declare let currentEffect: ReactiveEffect | null;
/**
 ...
 */
export declare function withDetachedCurrentEffect<T>(fn: () => T): T;
/**
 ...
 */
export declare function pushEffect(effect: ReactiveEffect): void;
/**
 ...
 */
export declare function getCurrentEffect(): ReactiveEffect | null;
