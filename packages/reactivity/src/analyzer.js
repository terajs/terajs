 ...
 */
export function analyzeReactivity(value, context) {
    if (Array.isArray(value) && value.length > LARGE_ARRAY_THRESHOLD) {
        // eslint-disable-next-line no-console
        console.warn(`[Terajs Analyzer] Large array (${value.length} items) made reactive${contextMsg(context)}.\n` +
        ...
        // eslint-disable-next-line no-console
        console.warn(`[Terajs Analyzer] Large object (${Object.keys(value).length} keys) made reactive${contextMsg(context)}.\n` +
