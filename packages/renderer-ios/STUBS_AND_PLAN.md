...
- package-local prop and event normalization from Terajs-style names to UIKit-facing bridge payloads, including input hints, selection and caret props, textarea line-count props, secure, keyboard, and correction traits, and image accessibility aliases
