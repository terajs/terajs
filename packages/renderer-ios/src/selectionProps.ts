export interface UIKitNormalizedSelectionPropUpdate {
  name: string;
  value: unknown;
}

export interface UIKitNormalizedSelectionProp extends UIKitNormalizedSelectionPropUpdate {
  additional?: UIKitNormalizedSelectionPropUpdate[];
}

const UIKitSelectionViewTypes = new Set(["UITextField", "UITextView"]);

function normalizeSelectionKey(name: string): string {
...
function createSelectionProp(start: number | null, end: number | null): UIKitNormalizedSelectionProp {
  return {
    name: "selectionStart",
    value: start,
    additional: [{
...
function normalizeSelectionRange(value: unknown): { start: number | null; end: number | null } | null {
  if (value == null) {
    return {
      start: null,
      end: null
...
export function normalizeUIKitSelectionProp(
  viewType: string,
  name: string,
  value: unknown
): UIKitNormalizedSelectionProp | null {
  if (!UIKitSelectionViewTypes.has(viewType)) {
    return null;
  }
