...
For native renderer branch work, `npm run test:universal:native` is the focused shared-source proof gate. It covers universal doctor readiness, shell materialization, release readiness doctors, generated artifact parity, emitted Android/iOS runtime behavior parity, and package-local native smoke checks.
