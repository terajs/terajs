...
- package-local prop and event normalization from Terajs-style names to Android-facing bridge payloads, including input placeholder, secure and keyboard traits, and image accessibility aliases
