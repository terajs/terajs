...
- package-local prop and event normalization from Terajs-style names to Android-facing bridge payloads, including input placeholder, selection and caret props, textarea line-count props, secure, keyboard, and correction traits, and image accessibility aliases
