...
- package-local native event ingress for text input text, composition payloads, structured text selection payloads, and switch state so host-session state and JS handlers stay aligned
