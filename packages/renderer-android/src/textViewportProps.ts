export interface AndroidTextViewportInsets {
  top: number;
  right: number;
  bottom: number;
  left: number;
...
export interface AndroidNormalizedTextViewportProp {
  name: string;
  value: unknown;
}
...
function createInsets(top: number, right: number, bottom: number, left: number): AndroidTextViewportInsets {
  return { top, right, bottom, left };
}

function normalizeInsetList(values: readonly unknown[]): AndroidTextViewportInsets | null {
...
function normalizeInsetRecord(record: Record<string, unknown>): AndroidTextViewportInsets | null {
...
function normalizeTextViewportInsets(value: unknown): AndroidTextViewportInsets | null {
...
export function normalizeAndroidTextViewportProp(
  viewType: string,
  name: string,
  value: unknown
): AndroidNormalizedTextViewportProp | null {
