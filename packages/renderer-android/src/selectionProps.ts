...
function createSelectionProp(start: number | null, end: number | null): AndroidNormalizedSelectionProp {
  return {
    name: "selectionStart",
    value: start,
    additional: [{
...
export function normalizeAndroidSelectionProp(
  viewType: string,
  name: string,
  value: unknown
): AndroidNormalizedSelectionProp | null {
